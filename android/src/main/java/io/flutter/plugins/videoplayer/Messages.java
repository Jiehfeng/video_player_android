...
public class Messages {
  ...
  public static class CameraRotationMessage {
    ...
    private @NonNull Double roll;
    public @NonNull Double getRoll() { return roll; }
    public void setRoll(@NonNull Double setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"roll\" is null.");
      }
      this.roll = setterArg;
    }
    ...
    private @NonNull Double yaw;
    public @NonNull Double getYaw() { return yaw; }
    public void setYaw(@NonNull Double setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"yaw\" is null.");
      }
      this.yaw = setterArg;
    }

    /** Constructor is private to enforce null safety; use Builder. */
    private CameraRotationMessage() {}
    public static final class Builder {
      private @Nullable Long textureId;
      public @NonNull Builder setTextureId(@NonNull Long setterArg) {
        this.textureId = setterArg;
      ...
      public @NonNull Builder setRoll(@NonNull Double setterArg) {
        this.roll = setterArg;
        return this;
      }
      ...
      public @NonNull Builder setYaw(@NonNull Double setterArg) {
        this.yaw = setterArg;
        return this;
      }
      public @NonNull CameraRotationMessage build() {
        CameraRotationMessage pigeonReturn = new CameraRotationMessage();
        pigeonReturn.setTextureId(textureId);
    ...
    static @NonNull CameraRotationMessage fromMap(@NonNull Map<String, Object> map) {
      CameraRotationMessage pigeonResult = new CameraRotationMessage();
      Object textureId = map.get("textureId");
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer)textureId : (Long)textureId));
  ...
  public static class MediaFormatMessage {
    ...
    private @NonNull Long mediaFormat;
    public @NonNull Long getMediaFormat() { return mediaFormat; }
    public void setMediaFormat(@NonNull Long setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"mediaFormat\" is null.");
      }
      this.mediaFormat = setterArg;
    }

    /** Constructor is private to enforce null safety; use Builder. */
    private MediaFormatMessage() {}
    public static final class Builder {
      private @Nullable Long textureId;
      public @NonNull Builder setTextureId(@NonNull Long setterArg) {
        this.textureId = setterArg;
      ...
      private @Nullable Long mediaFormat;
      public @NonNull Builder setMediaFormat(@NonNull Long setterArg) {
        this.mediaFormat = setterArg;
        return this;
      }
      public @NonNull MediaFormatMessage build() {
        MediaFormatMessage pigeonReturn = new MediaFormatMessage();
        pigeonReturn.setTextureId(textureId);
        pigeonReturn.setMediaFormat(mediaFormat);
        return pigeonReturn;
      }
    }
    @NonNull Map<String, Object> toMap() {
    ...
    static @NonNull MediaFormatMessage fromMap(@NonNull Map<String, Object> map) {
      MediaFormatMessage pigeonResult = new MediaFormatMessage();
      Object textureId = map.get("textureId");
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer)textureId : (Long)textureId));
      Object mediaFormat = map.get("mediaFormat");
      pigeonResult.setMediaFormat((mediaFormat == null) ? null : ((mediaFormat instanceof Integer) ? (Integer)mediaFormat : (Long)mediaFormat));
      return pigeonResult;
    }
  }
  private static class AndroidVideoPlayerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, ByteBuffer buffer) {
      switch (type) {
        case (byte)128:         
          return CameraRotationMessage.fromMap((Map<String, Object>) readValue(buffer));
        ...
        case (byte)131:         
          return MediaFormatMessage.fromMap((Map<String, Object>) readValue(buffer));
    ...
    protected void writeValue(ByteArrayOutputStream stream, Object value)     {
      if (value instanceof CameraRotationMessage) {
        stream.write(128);
        writeValue(stream, ((CameraRotationMessage) value).toMap());
      } else 
      ...
      if (value instanceof MediaFormatMessage) {
        stream.write(131);
        writeValue(stream, ((MediaFormatMessage) value).toMap());
      } else 
      ...
      } else 
{
  ...
  public interface AndroidVideoPlayerApi {
    ...
    void setCameraRotation(@NonNull CameraRotationMessage msg);
    void setMediaFormat(@NonNull MediaFormatMessage msg);
    ...
    static void setup(BinaryMessenger binaryMessenger, AndroidVideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setCameraRotation", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ArrayList<Object> args = (ArrayList<Object>)message;
              CameraRotationMessage msgArg = (CameraRotationMessage)args.get(0);
              if (msgArg == null) {
                throw new NullPointerException("msgArg unexpectedly null.");
              }
              api.setCameraRotation(msgArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setMediaFormat", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ArrayList<Object> args = (ArrayList<Object>)message;
              MediaFormatMessage msgArg = (MediaFormatMessage)args.get(0);
              if (msgArg == null) {
                throw new NullPointerException("msgArg unexpectedly null.");
              }
              api.setMediaFormat(msgArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
